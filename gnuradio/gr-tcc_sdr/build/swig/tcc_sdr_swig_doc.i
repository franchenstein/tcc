...
%feature("docstring") gr::tcc_sdr::interleaver_bb "<+description of block+>"

%feature("docstring") gr::tcc_sdr::interleaver_bb::make "Return a shared_ptr to a new instance of tcc_sdr::interleaver_bb.

To avoid accidental use of raw pointers, tcc_sdr::interleaver_bb's constructor is in a private implementation class. tcc_sdr::interleaver_bb::make is the public interface for creating new instances.
